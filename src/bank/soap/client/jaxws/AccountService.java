 ...
 * 
 */
@WebServiceClient(name = "AccountService", targetNamespace = "http://soap.bank/", wsdlLocation = "http://localhost:9876/hs?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ACCOUNTSERVICE_QNAME = new QName("http://soap.bank/", "AccountService");
    ...
    public Account getAccountPort() {
        return super.getPort(new QName("http://soap.bank/", "AccountPort"), Account.class);
    }
    ...
    public Account getAccountPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.bank/", "AccountPort"), Account.class, features);
    }
